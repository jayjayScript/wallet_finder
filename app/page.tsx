...
const WALLETS: Wallet[] = [
  /* — Exchanges — */
  {
    ...
    abbr: "CB",
    logo: CMC(89),
    desc: "US-based regulated exchange",
  },
  {
    id: "binance",
    name: "Binance",
  ...
  },
  {
    ...
    abbr: "CDC",
    logo: CMC(1149),
    desc: "Global crypto payments platform",
  },
  {
    id: "gemini",
    name: "Gemini",
    ...
    abbr: "GM",
    logo: CMC(36),
    desc: "Regulated New York exchange",
  },
  {
    id: "kucoin",
    name: "KuCoin",
  ...
  },
  {
    ...
    abbr: "OKX",
    logo: CMC(294),
    desc: "Advanced derivatives platform",
  },
  {
    id: "bybit",
    name: "Bybit",
  ...
  },
  {
    ...
    abbr: "BFX",
    logo: CMC(37),
    desc: "Advanced order types & tools",
  },
  {
    id: "htx",
    name: "HTX",
    ...
    abbr: "HTX",
    logo: CMC(102),
    desc: "Global digital asset exchange",
  },
  {
    id: "gate-io",
    name: "Gate.io",
    ...
    abbr: "GT",
    logo: GF("gate.io"),
    desc: "1600+ altcoin trading pairs",
  },
  {
    id: "mexc",
    name: "MEXC",
    ...
    abbr: "MX",
    logo: CMC(544),
    desc: "High-speed matching engine",
  },
  /* — Web3 Wallets — */
  {
    id: "web4",
    ...
    color: "#58a6ff",
    abbr: "W4",
    logo: GF("droidindex-web4.com"),
    desc: "AI-powered quantum-resistant Web4 wallet",
    pinned: true,
  },
  {
    id: "metamask",
    ...
    desc: "Browser extension EVM wallet",
  },
  {
    id: "trust-wallet",
    name: "Trust Wallet",
    ...
    desc: "Binance's mobile wallet app",
  },
  {
    id: "phantom",
    name: "Phantom",
  ...
  },
  {
    ...
    abbr: "LG",
    logo: GF("ledger.com"),
    desc: "Hardware wallet companion",
  },
  {
    id: "coinbase-wallet",
    ...
    color: "#1652F0",
    abbr: "CW",
    logo: GF("coinbase.com"),
    desc: "Self-custody DeFi wallet",
  },
  {
    id: "rainbow",
    name: "Rainbow",
    ...
    abbr: "RB",
    logo: GF("rainbow.me"),
    desc: "Ethereum wallet for humans",
  },
  {
    id: "argent",
    name: "Argent",
    ...
    abbr: "AG",
    logo: GF("argent.xyz"),
    desc: "Smart contract security wallet",
  },
  {
    id: "zerion",
    name: "Zerion",
  ...
  },
  {
    ...
    color: "#7C3AED",
    abbr: "AW",
    logo: GF("atomicwallet.io"),
    desc: "Multi-asset decentralized wallet",
  },
];
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "var(--gh-canvas)" }}>
      ...
      >
        {/* ─── Hero ─── */}
        <section
          style={{ padding: "72px 0 56px", textAlign: "center" }}
        ...
        >
          ...
          >
            Discover Wallets <span className="text-gradient">Linked to</span>
            <br />
            Any Email Address
          </h1>
          ...
          >
            Scan{" "}
            <strong style={{ color: "var(--gh-text-primary)" }}>
              12 exchanges
            </strong>{" "}
            and{" "}
            <strong style={{ color: "var(--gh-text-primary)" }}>
            ...
            to instantly surface which accounts are active on any email.
          </p>
        ...
        {hasSearched && (
          <div
            className="gh-card scanline-container"
          ...
          >
            ...
            >
              <div style={{ marginBottom: 12, color: "var(--gh-text-muted)" }}>
                ...
                <span style={{ color: "var(--gh-purple)" }}>--email</span>{" "}
                &ldquo;{scannedEmail}&rdquo;
              </div>
              ...
              {terminalDone && (
                ...
                >
                  <span>⚡</span>
                  Extended scan in progress — cross-referencing additional data
                  sources
                  <span
                    className="terminal-cursor"
                    style={{ backgroundColor: "var(--gh-yellow)" }}
                  />
                </div>
              )}
            </div>
              ...
              >
                {Array.from({ length: 4 }).map((_, i) => (
                  <SkeletonCard
                    ...
                    delay={(skeletonList.length + i) * 55}
                  />
                ))}
              </div>
              <div
              ...
              {[
                {
                  step: "01",
                  title: "Enter Email",
                  desc: "Type any email address into the search field above.",
                },
                {
                  step: "02",
                  title: "Scan Wallets",
                  desc: "We query 23 wallets across exchanges and Web3 platforms.",
                },
                {
                  step: "03",
                  title: "View Results",
                  desc: "See which wallets are active or inactive for that email.",
                },
              ].map((item) => (
                <div
                  key={item.step}
                  className="gh-card"
                  style={{ padding: "22px 20px", textAlign: "left" }}
                >
                  <div
                    style={{
                      fontSize: 11,
      ...
      >
        <span className="code-tag" style={{ marginRight: 10 }}>
          WalletFinder
        </span>
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 10,
        background:
          "linear-gradient(135deg, #58a6ff 0%, #bc8cff 60%, #3fb950 100%)",
        boxShadow:
          "0 0 32px rgba(88,166,255,0.2), 0 0 60px rgba(188,140,255,0.12)",
      }}
    >
      <div
        className="web4-card-inner"
        style={{
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <div
            ...
            style={{
              ...
              flexShrink: 0,
              background:
                "linear-gradient(135deg, rgba(88,166,255,0.18), rgba(188,140,255,0.18))",
          ...
          >
            <WalletIcon
              wallet={WALLETS.find((w) => w.id === "web4")!}
              size={52}
            />
          </div>
          <div>
            ...
            >
              ...
              <span
                style={{
                  ...
                  borderRadius: 20,
                  background:
                    "linear-gradient(90deg, rgba(88,166,255,0.2), rgba(188,140,255,0.2))",
            ...
            >
              AI-powered crypto wallet with quantum-resistant encryption — buy,
              trade & hold top altcoins
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              {[
                ...
                <span key={tag} className="code-tag" style={{ fontSize: 10 }}>
                  {tag}
                </span>
              ))}
            </div>
        ...
        <div
          className="web4-card-right-section"
          style={{
            display: "flex",
